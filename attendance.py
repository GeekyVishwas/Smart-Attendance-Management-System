...
class attendance:
    def __init__(self,root):
        ...
        img3=Image.open(r"college_images\BIT.jpg")
        ...
        title_lbl=Label(bg_img,text="ATTENDANCE MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="pink",fg="black")
        ...
        left_inside_frame.place(x=0,y=135,width=745,height=359)
        ...
        attendanceId_label.grid(row=0,column=0,padx=4,pady=8)
        ...
        btn_frame.place(x=0,y=220,width=740,height=38)

        save_btn=Button(btn_frame,text="Import csv",command=self.importCsv,cursor="hand2",width=23,font=("times new roman",13,"bold"),bg="skyblue",fg="black")
        save_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame,text="Export csv",command=self.exportCsv,cursor="hand2",width=24,font=("times new roman",13,"bold"),bg="pink",fg="black")
        update_btn.grid(row=0,column=1)

        #delete_btn=Button(btn_frame,text="Update",cursor="hand2",width=18,font=("times new roman",13,"bold"),bg="skyblue",fg="black")
        #delete_btn.grid(row=0,column=2)

        reset_btn=Button(btn_frame,text="Reset",command=self.reset_data,cursor="hand2",width=24,font=("times new roman",13,"bold"),bg="pink",fg="black")
        ...
        table_frame.place(x=5,y=5,width=730,height=470)
        ...
        self.AttendanceReportTable=ttk.Treeview(table_frame,column=("ID","Roll No.","Name","Department","Time","Date","Attendance Status"),xscrollcommand=scroll_x.set , yscrollcommand=scroll_y.set)
